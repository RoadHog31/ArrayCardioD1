...
const inventorFilter = inventors.filter(inventorbornIn1500s);
...
const inventorfirstandlastnames = inventors.map(getfirstandLastNames)

function getfirstandLastNames(value) {
